...
describe('Bonus : Compter cases accessibles', () => {
  ...
  test('compte 1 si personnage isolé', () => {
    ...
    plateau.cases[0] = "bloqué"; plateau.cases[1] = "bloqué"; plateau.cases[2] = "bloqué";
    plateau.cases[3] = "bloqué"; /* (1,1) libre */ plateau.cases[5] = "bloqué";
    plateau.cases[6] = "bloqué"; plateau.cases[7] = "bloqué"; plateau.cases[8] = "bloqué";
